...
Image *ReadImage(const char* filename)
{
	...
	{
		if (!EOF)//added a check to see if it reached the end of the file, if it has, not trying to copy as to not overflow from the  file
		//this way, even if the header is wrong, it wont try to read from outside the file
		{
